...
fn main() -> ! {
    ...
    let efm32 = efm32pg23_pac::efm32pg23b310::Peripherals::take().unwrap();
    // enable GPIO clock
    ...
    efm32
        .GPIO
        .pe_doutset
        .write(|w_reg| w_reg.doutset().variant(1 << 8));
    efm32
        .GPIO
        .pe_doutclr
        .write(|w_reg| w_reg.doutclr().variant(1 << 9));
    ...
    loop {
        ...
        if !is_set {
            ...
            efm32
                .GPIO
                .pe_doutclr
                .write(|w_reg| w_reg.doutclr().variant(1 << 8));
            efm32
                .GPIO
                .pe_doutset
                .write(|w_reg| w_reg.doutset().variant(1 << 9));
        }
